      ...
      blocks: [
        ...
        DiagramBlock(
          ...
          regions: [
            DiagramRegion(
              label: 'Head (total)',
              detail: 'Lund-Browder: 19% at 0-1 yr, decreasing to 7% in adults. Modified Rule of 9s uses 18% infant / 9% adult. Largest proportional change across childhood.',
            ...
            DiagramRegion(
              ...
              detail: 'Lund-Browder: 13% at all ages. (Modified Rule of 9s groups trunk + buttocks as 18% anterior.) Constant across age groups.',
              icon: Icons.accessibility_new_rounded,
              color: const Color(0xFFEAB308),
            ),
            DiagramRegion(
              label: 'Posterior Trunk',
              detail: 'Lund-Browder: 13% at all ages, plus each buttock 2.5% (5% combined). Constant across age groups.',
              icon: Icons.airline_seat_flat_rounded,
              color: const Color(0xFF22C55E),
            ),
            DiagramRegion(
              label: 'Each Thigh',
              detail: 'Lund-Browder: 5.5% at 0-1 yr, increasing to 9.5% in adults. Grows as head proportion decreases.',
              icon: Icons.directions_walk_rounded,
              color: const Color(0xFF3B82F6),
            ),
            DiagramRegion(
              label: 'Each Lower Leg + Foot',
              detail: 'Lower leg: 5% in infants to 7% in adults. Foot: 3.5% at all ages. Whole leg (thigh+lower leg+foot) totals ~14% in infants and ~18-20% in adults.',
